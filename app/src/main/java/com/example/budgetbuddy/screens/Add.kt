...
//    if(appViewModel.calendarId==100.toLong()){
//        CalendarPermission2()
//        LazyColumn {
//            items(obtenerIdsCalendario(context)){calendario ->
//                Text(text = "${calendario.first}: ${calendario.second}",
//                    modifier = Modifier.clickable { appViewModel.calendarId = calendario.first },
